...
{
       0,    57,    57,    59,    61,    61,    63,    65,    74,    83,
      92,   101,   101,   103,   117,   127,   131,   140,   149,   159,
     169,   178
};
#endif
...
{
  "$end", "error", "$undefined", "NUMBER", "TYPE", "ID", "MAIN", "'+'",
  "'-'", "'*'", "'/'", "'('", "')'", "'{'", "'}'", "';'", "','", "'='",
  "$accept", "program", "body", "varstmt", "vardecl", "varlist",
  "stmtlist", "stmt", "expr", YY_NULLPTR
};
#endif
...
{
       9,     5,    19,    10,   -28,    11,    16,    18,    12,    20,
      16,     4,    -2,   -28,    13,   -28,    20,   -28,    24,   -28,
      23,     6,   -28,   -28,    14,    17,    21,    -7,    26,   -28,
     -28,     7,     7,     7,     7,   -28,   -28,   -28,   -28,     8,
       8,   -28,   -28
};
...
{
       0,     0,     0,     0,     1,     0,     5,     0,     0,    12,
       5,    10,     0,     2,     0,     3,    12,     4,     0,     6,
       0,     0,    11,     8,     7,    21,    20,     0,     0,    13,
      14,     0,     0,     0,     0,    15,     9,    21,    20,    16,
      17,    18,    19
};
...
{
     -28,   -28,   -28,    25,   -28,   -28,    22,   -28,   -27
};

  /* YYDEFGOTO[NTERM-NUM].  */
static const yytype_int8 yydefgoto[] =
{
      -1,     2,     8,     9,    10,    12,    15,    16,    27
};
...
{
      31,    32,    33,    34,    39,    40,    41,    42,    35,    25,
      37,    26,    38,    19,    20,     1,     3,    33,    34,     4,
       7,    18,     5,    11,     6,    14,    13,    23,    24,    36,
      21,    28,    29,     0,     0,    17,    30,     0,    22
};

static const yytype_int8 yycheck[] =
{
       7,     8,     9,    10,    31,    32,    33,    34,    15,     3,
       3,     5,     5,    15,    16,     6,    11,     9,    10,     0,
       4,    17,    12,     5,    13,     5,    14,     3,     5,     3,
      17,    17,    15,    -1,    -1,    10,    15,    -1,    16
};
...
{
       0,     6,    19,    11,     0,    12,    13,     4,    20,    21,
      22,     5,    23,    14,     5,    24,    25,    21,    17,    15,
      16,    17,    24,     3,     5,     3,     5,    26,    17,    15,
      15,     7,     8,     9,    10,    15,     3,     3,     5,    26,
      26,    26,    26
};
...
{
       0,    18,    19,    20,    21,    21,    22,    23,    23,    23,
      23,    24,    24,    25,    25,    25,    26,    26,    26,    26,
      26,    26
};
...
yyreduce:
  ...
  switch (yyn)
    {
        case 7:
#line 65 "icg_yacc.y" /* yacc.c:1646  */
    {                
				int i;
				i=search_symbol((yyvsp[0].string));
			 	if(i!=-1)
					printf("\n Multiple Declaration of Variable");
				 	...
				 	make_symtab_entry((yyvsp[0].string),(yyvsp[-3].string),0);
		 		}
#line 1277 "y.tab.c" /* yacc.c:1646  */
    break;

  case 8:
#line 74 "icg_yacc.y" /* yacc.c:1646  */
    {
				int i;
				...
				if(i!=-1)
					...
					make_symtab_entry((yyvsp[-2].string),(yyvsp[-3].string),(yyvsp[0].dval));
				}
#line 1290 "y.tab.c" /* yacc.c:1646  */
    break;

  case 9:
#line 83 "icg_yacc.y" /* yacc.c:1646  */
    {
				int i;
				i=search_symbol((yyvsp[-2].string));
				if(i!=-1)
					...
					make_symtab_entry((yyvsp[-2].string),(yyvsp[-5].string),(yyvsp[0].dval));
				}
#line 1303 "y.tab.c" /* yacc.c:1646  */
    break;

  case 10:
#line 92 "icg_yacc.y" /* yacc.c:1646  */
    {                
				int i;
				i=search_symbol((yyvsp[0].string));
				if(i!=-1)
...
#line 1316 "y.tab.c" /* yacc.c:1646  */
  ...
  case 13:
#line 103 "icg_yacc.y" /* yacc.c:1646  */
    {
			       	int i;
...
#line 1335 "y.tab.c" /* yacc.c:1646  */
  ...
  case 14:
#line 117 "icg_yacc.y" /* yacc.c:1646  */
    {
				int i,j;
				i=search_symbol((yyvsp[-3].string));
...
#line 1349 "y.tab.c" /* yacc.c:1646  */
  ...
  case 15:
#line 127 "icg_yacc.y" /* yacc.c:1646  */
    { 
...
#line 1357 "y.tab.c" /* yacc.c:1646  */
  ...
  case 16:
#line 131 "icg_yacc.y" /* yacc.c:1646  */
    {
			      	char str[5],str1[5]="t";
...
#line 1370 "y.tab.c" /* yacc.c:1646  */
  ...
  case 17:
#line 140 "icg_yacc.y" /* yacc.c:1646  */
    {
				char str[5],str1[5]="t";
				sprintf(str, "%d", temp_var);   
				strcat(str1,str);
...
#line 1383 "y.tab.c" /* yacc.c:1646  */
  ...
  case 18:
#line 149 "icg_yacc.y" /* yacc.c:1646  */
    {
				char str[5],str1[5]="t";
				sprintf(str, "%d", temp_var);       
...
#line 1397 "y.tab.c" /* yacc.c:1646  */
  ...
  case 19:
#line 159 "icg_yacc.y" /* yacc.c:1646  */
    {
				char str[5],str1[5]="t";
				sprintf(str, "%d", temp_var);       
...
#line 1411 "y.tab.c" /* yacc.c:1646  */
  ...
  case 20:
#line 169 "icg_yacc.y" /* yacc.c:1646  */
    {                     
				int i;
				i=search_symbol((yyvsp[0].string));
				if(i==-1)
...
#line 1424 "y.tab.c" /* yacc.c:1646  */
  ...
  case 21:
#line 178 "icg_yacc.y" /* yacc.c:1646  */
    {       
				char temp[10];
...
#line 184 "icg_yacc.y" /* yacc.c:1906  */
